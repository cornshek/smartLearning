            ...
            <div class="panel panel-default">
                ...
                <table>
                    <tr id="again" style="display: none">
                        <td>
                            <button class="btn btn-default btn-xs btn-info" style="padding: 1px 67px; font-size: 50px; background-color: #555; border-color: white" onClick="location.href='student_memorizeTheorem?number=5'">再来5个
                            <button class="btn btn-default btn-xs btn-info" style="padding: 1px 53px; font-size: 50px; background-color: #555; border-color: white" onClick="location.href='student_memorizeTheorem?number=10'">再来10个
                            <button class="btn btn-default btn-xs btn-info" style="padding: 1px 54px; font-size: 50px; background-color: #555; border-color: white" onClick="location.href='student_memorizeTheorem?number=20'">再来20个
                            <%--用不闭合标签的方式解决按钮间空隙的问题--%>
                        </td>
                    </tr>
                    <tr>
