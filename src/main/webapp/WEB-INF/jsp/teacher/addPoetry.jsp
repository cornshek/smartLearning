            ...
            <div class="col-md-10">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row">
                            <h1 style="text-align: center;">添加知识点-古诗</h1>
                        </div>
                    </div>
                    <div class="panel-body">
                        <form class="form-horizontal" action="teacher_addPoetry" id="editForm" method="post">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">题干</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="blank" placeholder="请输入题干">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">答案</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="fill" placeholder="请输入答案">
                                </div>
                            </div>
                            <div class="form-group">
